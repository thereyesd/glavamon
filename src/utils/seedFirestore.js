...
export async function seedDatabase() {
  ...
  try {
    ...
    // Agregar estilistas
    console.log('Agregando estilistas...')
    ...
    console.log(`✓ ${stylists.length} estilistas agregados`)

    // Agregar configuración
    console.log('Agregando configuración...')
    await setDoc(doc(db, 'businessConfig', 'config'), businessConfig)
    console.log('✓ Configuración agregada')
...
export async function makeCurrentUserAdmin() {
  ...
  try {
    ...
    console.log('🔄 Cierra sesión y vuelve a entrar para ver el panel admin.')
    return true
  } catch (error) {
